...
export default class Widgets extends Component {
    ...
    render({idWidgetsBlock, widgetsLibrary, widgetAliasCode, widgetUrl, publicKey, noCache, addMessage}, {topForPos}){
        return (<section class="widgets" id={idWidgetsBlock}>
            ...
            <div class="widgets__library" ref={ c => this.widgetLibraryBlock = c }>
                ...
                <Library widgetsLibrary={{...widgetsLibrary,widgetUrl,publicKey,noCache,addMessage,widgetAliasCode}}/>
            </div>
